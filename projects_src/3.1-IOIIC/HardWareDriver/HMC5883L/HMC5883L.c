...
IOIIC_Pin_t hmc5883_iic;

#define SCLCLOCK RCC_AHB1Periph_GPIOD
#define SCLPORT GPIOD
#define SCLPIN 6
#define SDACLOCK RCC_AHB1Periph_GPIOD
#define SDAPORT GPIOD
#define SDAPIN 7

void hmc5883_iic_config(void)
{
	// procedure for IOIIC initialization.
//	hmc5883_iic.SDA_Port = GPIOD;
//	hmc5883_iic.SCL_Port = GPIOD;
//	hmc5883_iic.SCL_Pin = 6;
//	hmc5883_iic.SDA_Pin = 7;

//	GPIO_InitTypeDef GPIO_InitStructure;
//	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD, ENABLE);
//	GPIO_InitStructure.GPIO_Pin = (1<<6) | (1<<7);
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
//	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;
//	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
//	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
//	GPIO_Init(hmc5883_iic.SCL_Port, &GPIO_InitStructure);
//	
	hmc5883_iic.SCL_Port = SCLPORT;
	hmc5883_iic.SDA_Port = SDAPORT;
	
	hmc5883_iic.SCL_Pin = SCLPIN;
	hmc5883_iic.SDA_Pin = SDAPIN;
...
//extern IOIIC_Pin_t hmc5883_iic;
...
{
	IICwriteByte(HMC58X3_ADDR, reg, val, &hmc5883_iic);
}
...
void HMC58X3_getRaw(int16_t *x, int16_t *y, int16_t *z)
{
	...
	IICreadBytes(HMC58X3_ADDR, HMC58X3_R_XM, 6, vbuff, &hmc5883_iic);
...
{
	id[0] = I2C_ReadOneByte(HMC58X3_ADDR, HMC58X3_R_IDA, &hmc5883_iic);
	id[1] = I2C_ReadOneByte(HMC58X3_ADDR, HMC58X3_R_IDB, &hmc5883_iic);
	id[2] = I2C_ReadOneByte(HMC58X3_ADDR, HMC58X3_R_IDC, &hmc5883_iic);
}   // getID().
