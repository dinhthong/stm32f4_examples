#line 1 "..\\HardWareDriver\\MPU6050\\MPU6050.c"
...
#line 2 "..\\HardWareDriver\\MPU6050\\MPU6050.c"
...
#line 3 "..\\HardWareDriver\\MPU6050\\MPU6050.c"
#line 4 "..\\HardWareDriver\\MPU6050\\MPU6050.c"
...
void  MPU6050_newValues(int16_t ax, int16_t ay, int16_t az, int16_t gx, int16_t gy, int16_t gz)
{
	...
	MPU6050_FIFO[0][10] = MPU6050_getAvg(MPU6050_FIFO[0], 10);
	MPU6050_FIFO[1][10] = MPU6050_getAvg(MPU6050_FIFO[1], 10);
	MPU6050_FIFO[2][10] = MPU6050_getAvg(MPU6050_FIFO[2], 10);
	MPU6050_FIFO[3][10] = MPU6050_getAvg(MPU6050_FIFO[3], 10);
	MPU6050_FIFO[4][10] = MPU6050_getAvg(MPU6050_FIFO[4], 10);
	MPU6050_FIFO[5][10] = MPU6050_getAvg(MPU6050_FIFO[5], 10);
}
...
void MPU6050_initialize(void)
{
	...
	IICwriteBit(0xD0, 0x37, 7, 0);
	IICwriteBit(0xD0, 0x37, 6, 0);
	IICwriteBit(0xD0, 0x37, 5, 1);
	IICwriteBit(0xD0, 0x37, 4, 1);
	
	IICwriteBit(0xD0, 0x38, 0, 1);

	IICwriteBits(0xD0, 0x1A, 7, 8, 0x03); 
...
{
	if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint16_t)0x0200)) == Bit_SET)
	{
		return 1;
	}
	else return 0;
...
void MPU6050_getMotion6(int16_t *ax, int16_t *ay, int16_t *az, int16_t *gx, int16_t *gy, int16_t *gz)
{
	...
	if(MPU6050_is_DRY())
	{
		...
		IICreadBytes(0xD0, 0x3B, 14, buffer);
...
void MPU6050_Calculate_Gyro_Offset(float *gx_offset,float *gy_offset,float *gz_offset,uint16_t steps)
{
	...
	*gx_offset = tempgx /steps; 
	*gy_offset = tempgy / steps; 
	*gz_offset = tempgz / steps; 
}
