#line 1 "..\\HardWareDriver\\MS5611\\ms5611.c"
...
#line 2 "..\\HardWareDriver\\MS5611\\ms5611.c"
...
#line 3 "..\\HardWareDriver\\MS5611\\ms5611.c"
#line 4 "..\\HardWareDriver\\MS5611\\ms5611.c"
	uint16_t fc[6];
	uint8_t ct;
	uint8_t uosr;
...
void update_baro(float *temperature, long *pressure, float *alti) {	
  switch (pressureState){
    case 0:
	  ...
	  timer = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00))->CNT*0.001;
    ms5611WriteByte((0x50) + uosr);
    break;
    case 1:
      if (((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00))->CNT*0.001 - timer >= ct) {
        pressureState = 2;
    ...
    break;
    case 2:
      timer1 = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00))->CNT*0.001;
       ms5611WriteByte((0x40) + uosr);       
      pressureState = 3;
    break;    
    case 3:			  
      if (((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00))->CNT*0.001 - timer1 >= ct) {	          
         up = readRawPressure(); 
...
{  uint8_t offset;
    ...
    {
	fc[offset] = readRegister16((0xA2) + (offset * 2));
    }
}
