#line 1 "..\\HardWareDriver\\HMC5883L\\HMC5883L.c"
...
#line 5 "..\\HardWareDriver\\HMC5883L\\HMC5883L.c"
...
#line 6 "..\\HardWareDriver\\HMC5883L\\HMC5883L.c"
...
{
	if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint16_t)0x0100)) == Bit_SET)
	{
		return 1;
	}
	else return 0;
...
void  HMC58X3_newValues(int16_t x, int16_t y, int16_t z)
{
	...
	HMC5883_Buf_index = (HMC5883_Buf_index + 1) % 10;
...
void HMC58X3_init(u8 setmode)
{
	...
	HMC58X3_writeReg(0, 0x70); 
	HMC58X3_writeReg(1, 0xA0);
	HMC58X3_writeReg(2, 0x00);
...
void HMC58X3_getID(char id[3])
{
	id[0] = I2C_ReadOneByte(0x3C, 10);
	id[1] = I2C_ReadOneByte(0x3C, 11);
	id[2] = I2C_ReadOneByte(0x3C, 12);
}   
