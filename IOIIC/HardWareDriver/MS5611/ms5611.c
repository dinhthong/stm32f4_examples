...
#define SCLCLOCK RCC_AHB1Periph_GPIOE
#define SCLPORT GPIOE
#define SCLPIN 2
#define SDACLOCK RCC_AHB1Periph_GPIOE
#define SDAPORT GPIOE
#define SDAPIN 3
IOIIC_Pin_t ms5611_iic;
void ms5611_iic_config(void)
{
	// procedure for IOIIC initialization.
	ms5611_iic.SCL_Port = SCLPORT;
	ms5611_iic.SDA_Port = SDAPORT;
	
	ms5611_iic.SCL_Pin = SCLPIN;
	ms5611_iic.SDA_Pin = SDAPIN;
...
uint16_t readRegister16(uint8_t reg)
{
    uint16_t value;
		u8 data[2];
	//uint17_t value;
	IICreadBytes(MS5611_ADDRESS,reg,2,data, &ms5611_iic);
...
uint32_t readRegister24(uint8_t reg)
{
  ...
  unsigned long xsb=0;
	u8 data[3];
	uint32_t value;
	IICreadBytes(MS5611_ADDRESS,reg,3,data, &ms5611_iic);
...
{
	IICwriteByte(MS5611_ADDRESS, 0, data, &ms5611_iic);
}
